...
// More data generators for the additional types
...
const generateEnrollmentMock = () => {
  return {
    enrolled_at: new Date().toISOString()
  };
};

const generateQuizMock = () => {
  const titles = [
    'Quiz de Evaluación',
      ...
      for (let i = 0; i < count; i++) {
        ...
        switch (type) {
          ...
          case 'message':
            ...
            break;
          case 'module':
            mockData = generateModuleMock();
            name = mockData.title;
            break;
          case 'profile':
            mockData = generateProfileMock();
            name = mockData.full_name;
            break;
          case 'assignment':
            mockData = generateAssignmentMock();
            name = mockData.title;
            break;
          case 'category':
            mockData = generateCategoryMock();
            name = mockData.name;
            break;
          case 'enrollment':
            mockData = generateEnrollmentMock();
            name = `Enrollment ${i + 1}`;
            break;
          case 'quiz':
            mockData = generateQuizMock();
            name = mockData.title;
            break;
          case 'certificate':
            mockData = generateCertificateMock();
            name = mockData.certificate_number;
            break;
          case 'payment':
            mockData = generatePaymentMock();
            name = `Payment ${i + 1}`;
            break;
          default:
            mockData = {};
