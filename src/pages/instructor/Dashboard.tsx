...
import { ArrowUpRight, PlusCircle, Users, BookOpen, Medal, Clock } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  return (
    <SectionPageLayout
      ...
      subtitle="Gestiona tus cursos y estudiantes"
      actions={[
        ...
        <div className="col-span-2">
          <Tabs defaultValue="popular" className="w-full">
            ...
            <TabsContent value="popular" className="mt-0 pt-4">
              <PopularCoursesCard courses={popularCourses} isLoading={isLoading} />
            </TabsContent>
            <TabsContent value="recent" className="mt-0 pt-4">
              <RecentEnrollmentsCard enrollments={recentEnrollments} isLoading={isLoading} />
            </TabsContent>
          </Tabs>
        </div>
        <Card>
