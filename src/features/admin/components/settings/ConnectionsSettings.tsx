    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configura los proveedores de pago para procesar transacciones
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Proveedores de Login Social</CardTitle>
          <CardDescription>
            Configura las opciones de inicio de sesión con proveedores externos
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configura las opciones para almacenamiento y streaming de video
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configura los servicios de envío de correos electrónicos
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Otras APIs</CardTitle>
          <CardDescription>
            Conecta con servicios externos adicionales
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="rounded-md border p-4 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <Label>API de Inteligencia Artificial</Label>
