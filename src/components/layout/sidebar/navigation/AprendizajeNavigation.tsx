  ...
  return (
    ...
    >
      {isCollapsed ? (
        // Versión colapsada
        <>
          <CollapsedMenuItem to="/profile" icon={User} label="Mi Perfil" />
          <CollapsedMenuItem to="/calendar" icon={Calendar} label="Calendario" />
          <CollapsedMenuItem to="/scholarships" icon={Award} label="Becas" />
        </>
      ) : (
        // Versión expandida
        <>
          ...
          <MenuItem to="/scholarships" icon={Award} label="Becas" />
          <DisabledMenuItem
            icon={Award}
            label="Certificados"
